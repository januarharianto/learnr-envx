...
Assuming we resampled the **same locations** as the baseline survey use R to estimate the 95% CI for the change in mean between the 2 surveys. When we sample at same locations between surveys the *df* = number of paired sites - 1 = 5 - 1 = 4. 
