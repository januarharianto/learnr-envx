...
::: {.alert .alert-info}
In Weeks 1 to 3, Tutorials and Labs will be run in `learnr` format. *After* Week 3, we will return to the R Markdown formats as you will be familiar with this document format by then.
:::
